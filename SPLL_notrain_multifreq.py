...
if __name__ == "__main__":
    ...
    try:
        ...
        pass
    torch.save(torch.tensor(acc_coll),os.path.join(os.getcwd(),'seed_coll',f'SPLL_multifreq_acc_coll_{args.seed}.pt'))
    torch.save(decoder.state_dict(),os.path.join(os.getcwd(),'seed_coll',f'SPLL_multifreq_decoder_{args.seed}.pt'))
